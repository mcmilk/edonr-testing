...
void EdonRInit_new(EdonRState *state, size_t hashbitlen);
void EdonRUpdate_new(EdonRState *state, const uint8_t *data, size_t databitlen);
void EdonRFinal_new(EdonRState *state, uint8_t *hashval);
